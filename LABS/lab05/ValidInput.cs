...
namespace SeleniumTests
{
    ...
    public class ValidInput
    {
        ...
        public void TheValidInputTest()
        {
            ...
            driver.FindElement(By.Name("task")).SendKeys("Limpar");
            driver.FindElement(By.Id("pedido-form")).Click();
            driver.FindElement(By.Name("description")).Click();
            driver.FindElement(By.Name("description")).Clear();
            driver.FindElement(By.Name("description")).SendKeys("Limpar a minha casa");
